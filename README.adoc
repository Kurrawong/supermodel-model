...
////
NOTE (Les K):
SHACL uses sh:NodeShape and sh:PropertyShape. "sh:Shape" is not part of the standard SHACL vocabulary.

Leaving as-is here as this may be intentional abstraction.
////
